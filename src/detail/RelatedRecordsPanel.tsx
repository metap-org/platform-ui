 ...
 * consumer of `useGraphQLQuery`. Read-only, matching the gateway's own scope (see that crate's
 * README on why mutations shouldn't go through it) — mutating any of this data still goes
 * through each entity's own generic `/records/:entityName/*` REST screens.
 */
