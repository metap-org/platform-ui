...
const en = {
  ...
  detail: {
    ...
    auditActionTransition: "Transitioned",
    auditFieldChange: "{{field}}: {{before}} → {{after}}",
...
const vi = {
  ...
  detail: {
    ...
    historyEntry: "{{action}}: {{from}} → {{to}}",
    historyBy: "bởi {{actor}}",
    tabAudit: "Nhật ký thay đổi",
    auditEmpty: "Chưa có nhật ký thay đổi nào.",
    auditActionCreate: "Tạo mới",
    auditActionUpdate: "Cập nhật",
    auditActionDelete: "Xoá",
    auditActionTransition: "Chuyển trạng thái",
    auditFieldChange: "{{field}}: {{before}} → {{after}}",
    auditReason: "Lý do: {{reason}}",
    auditBy: "bởi {{actor}}",
  },
  login: {
    title: "Đăng nhập",
